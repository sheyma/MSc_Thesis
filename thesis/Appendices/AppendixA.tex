...
\lhead{Appendix A. \emph{Anatomical Description of Brain Nodes}} % This is for the header on each page - perhaps a shortened title

\begin{table}[htbp]\tiny
\begin{center}
\caption[AAL Description]{Anatomical Description of Brain Nodes }
\begin{tabular}{ l | l | r }
