...
Net_mes = load('A_Random_Gc_network_measures.dat');
Shor_pat = load('A_Random_Gc_shortest_path.dat');
Glo_ef = load('A_Random_Gc_global_efficiency.dat');
Loc_ef = load('A_Random_Gc_local_efficency.dat');
SWorld = load('A_Random_Gc_small_worldness.dat');

% network measures as distributions around nodes
deg_dis = load('A_Random_Gc_degree_dist.dat');
node_CC = load('A_Random_Gc_node_cc.dat');
comp_dist =load('A_Random_Gc_nodes_comp_.dat');
single_de =load('A_Random_Gc_single_degrees.dat');
