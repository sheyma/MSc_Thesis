...
#name = 'A_aal_a_ADJ_thr_0.54_sigma=0.5_D=0.05_v=90.0_tmax=45000_FHN_corr.dat'
name = 'A_aal_0_ADJ_thr_0.54_sigma=0.5_D=0.05_v=90.0_tmax=45000_FHN_corr.dat'
...
print bhatta_hists(HistA, HistB)
