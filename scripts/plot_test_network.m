...
for i =1:length(random_G)
    ...
    A=load(a);
    if color(i)=='g'
        plot(A(:,1),A(:,3),strcat(color(i),'^'),'LineWidth',4) 
    else
...
for i =1:length(random_G)
    ...
    if color(i) == 'g'
        plot(A(:,1),A(:,5),strcat(color(i),'^'),'LineWidth',4)  
    else
...
for i =1:length(random_G)
    A=load(strcat(input_name(1:6),'R',random_G(i),input_name(6:end)));
    if color(i) == 'g'
        plot(A(:,1),A(:,6),strcat(color(i),'^'),'LineWidth',4)  
    else
...
for i =1:length(random_G)
    A=load(strcat(input_name(1:6),'R',random_G(i),input_name(6:end)));
    if color(i) == 'g'
        plot(A(:,1),A(:,7),strcat(color(i),'^'),'LineWidth',4)  
    else
...
for i = 1:length(random_G)
    ...
    if color(i) == 'g'
        plot(A(:,1),A(:,8),strcat(color(i),'^'),'LineWidth',4)  
    else
...
for i = 1:length(random_G)
    ...
    A = load(a);
    if color(i) == 'g'
        plot(A(:,1),A(:,2),strcat(color(i),'^'),'LineWidth',4)  
    else
